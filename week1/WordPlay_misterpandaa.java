...
public class WordPlay_misterpandaa {
    ...
    public String replaceVowels(String phrase, char ch) {
        StringBuilder newPhrase = new StringBuilder(); // creeaza un sb si ii ofera valorile din phrase in functie de validarea vocalei
    ...
    public void testReplaceVowels() {
        ...
        for (int i = 0; i < phrase.length(); i++) {
            ...
            if (Character.toLowerCase(currentCharacter) == Character.toLowerCase(ch)) { // creeaza un sb cu caracterele de afisare dupa verificarea din fraza initiala
                if (i % 2 == 0) {
                    newPhrase.append('*');
                } else {
                    newPhrase.append('+');
